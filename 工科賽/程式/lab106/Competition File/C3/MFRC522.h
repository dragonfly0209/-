...
// --------IO pin Definition for MFRC522--------------
#define MFRC522_CS          LATAbits.LATA5
#define SCK                 LATEbits.LATE0
#define MOSI                LATEbits.LATE1
#define MISO                PORTEbits.RE2
#define MFRC522_IRQ         PORTBbits.RB4
#define MFRC522_RST         LATBbits.LATB5

// --------Function Declaration for SPI--------------
unsigned char SPI_transfer(unsigned char data);

// MFRC522 registers. Described in chapter 9 of the datasheet.
// When using SPI all addresses are shifted one bit left in the "SPI address byte" (section 8.1.2.3)
typedef enum _PCD_Register {
